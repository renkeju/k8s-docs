...
* [第五章 Pod 控制器](chapter_5/5.Pod_controller.md)
    ...
    * [5.5 Job控制器](chapter_5/5.5.Job_controller.md)
        * [5.5.1 创建Job对象](chapter_5/5.5.1.Create_Job_Object.md)
        * [5.5.2 并形式Job](chapter_5/5.5.2.And_form_Job.md)
        * [5.5.3 Job扩容](chapter_5/5.5.3.Job_expansion.md)
        * [5.5.4 删除Job](chapter_5/5.5.4.Delete_job.md)
    * [5.6 CronJob控制器](chapter_5/5.6.CronJob_Controller.md)
        * [5.6.1 创建CronJob对象](chapter_5/5.6.1.Create_CronJob_Object.md)
        * [5.6.2 CronJob的控制机制](chapter_5/5.6.2.CronJob's_Controller_mechanism.md)
...
* [第六章 Service 和 Ingress](chapter_6/6.Service_and_Ingress.md)
    ...
    * [6.4 服务暴露](chapter_6/6.4.Service_exposure.md)
        * [6.4.1 Service类型](chapter_6/6.4.1.Service_type.md)
        * [6.4.2 NodePort类型的Service资源](chapter_6/6.4.2.Service_resource_of_NodePort_type.md)
        * [6.4.3 LoadBalancer类型的Service资源](chapter_6/6.4.3.Service_resource_of_LoadBalancer_type.md)
        * [6.4.4 ExternalName Service](chapter_6/6.4.4.ExternalName_Service.md)
    * [6.5 Headless类型的Service资源](chapter_6/6.5.Service_resource_of_headless_type.md)
        * [6.5.1 创建Headless Service资源](chapter_6/6.5.1.Create_Headless_Service_resources.md)
        * [6.5.2 Pod资源发现](chapter_6/6.5.2.Pod_resource_discovery.md)
    * [6.6 Ingress资源](chapter_6/6.6.Ingress_resources.md)
        * [6.6.1 Ingress和Ingress Controller](chapter_6/6.6.1.Ingress_and_Ingress_Controller.md)
        * [6.6.2 创建Ingress资源](chapter_6/6.6.2.Create_Ingress_resources.md)
        * [6.6.3 Ingress资源类型](chapter_6/6.6.3.Ingress_resource_type.md)
        * [6.6.4 部署Ingress控制器（Nginx）](chapter_6/6.6.4.Deploy_the_Ingress_controller_Nginx.md)
    * [6.7 案例：使用Ingress发布tomcat](chapter_6/6.7.Case:_Use_Ingress_to_publish_tomcat.md)
        * [6.7.1 准备名称空间](chapter_6/6.7.1.Prepare_the_namespace.md)
        * [6.7.2 部署tomcat实例](chapter_6/6.7.2.Deploy_tomcat_instance.md)
        * [6.7.3 创建Service资源](chapter_6/6.7.3.Create_Service_Resources.md)
        * [6.7.4 创建Ingress资源](chapter_6/6.7.4.Create_Ingress_resources.md)
        * [6.7.5 配置TLS Ingress资源](chapter_6/6.7.5.Configure_TLS_Ingress_resources.md)
    * [6.8 本章小结](chapter_6/6.8.chapter_summary.md)
